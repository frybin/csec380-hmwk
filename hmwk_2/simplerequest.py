...
class SimpleRequest:
    ...
    def __init__(self, host, port='80', type='GET', resource='/', body='', contentType='application/x-www-form-urlencoded', request=''):
        ...
        Args:
            ...
            resource (str, optional): The resource being requested. Defaults to '/'.
    ...
    def send(self):
        """
        Send will send the HTTP request, wait for the response and return the data from the response
